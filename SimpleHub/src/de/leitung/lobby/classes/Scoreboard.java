...
public class Scoreboard {
	  public static String nextevent = "Laden";
	    ...
	    public static void setScoreboard(Player p) {
	        ...
	        Score s0 = ob.getScore(" §f§lDeine Clays:");
	        Score s1 = ob.getScore(" §a" + CoinsAPI.getCoins(p.getName()));
	        Score s2 = ob.getScore(ChatColor.YELLOW.toString());
	        Score s6 = ob.getScore(" §f§lAktuelle User:");
	        Score s7 = ob.getScore(" §a" + Main.totalplayers);
	        Score s8 = ob.getScore(" §f§lWebseite:");
	        Score s88 = ob.getScore(ChatColor.DARK_PURPLE.toString());
	        Score s9 = ob.getScore(" §aClayMC.net");
	        s9.setScore(1);
	        s8.setScore(2);
	        s88.setScore(3);
	        s7.setScore(4);
