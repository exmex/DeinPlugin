...
public class Scoreboard {
    ...
    public static void setScoreboard(Player p) {
        ...
        Team mod = board2.registerNewTeam("c");
        Team supp = board2.registerNewTeam("d");
        Team youtuberp = board2.registerNewTeam("e");
        ...
        ultra.setPrefix(ChatColor.AQUA + "Ultra" + (Object)ChatColor.DARK_GRAY + " \u25cf " + (Object)ChatColor.AQUA);
        ...
        youtuberp.setPrefix(ChatColor.DARK_PURPLE + "YT+" + (Object)ChatColor.DARK_GRAY + " \u25cf " + (Object)ChatColor.DARK_PURPLE);
