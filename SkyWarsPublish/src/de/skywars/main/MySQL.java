...
public class MySQL {
    ...
    public static void connect() {
        ...
        if(!isConnected()) {
            try {
                con = (Connection) DriverManager.getConnection("jdbc:mysql://"+ MYSQKLDATEN.Host + ":"+MYSQKLDATEN.Port + "/" + MYSQKLDATEN.Database + "?autoReconnect=true" , MYSQKLDATEN.Username , MYSQKLDATEN.Password);
