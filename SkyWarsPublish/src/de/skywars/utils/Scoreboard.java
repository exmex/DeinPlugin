...
public class Scoreboard {
    ...
    public static void setScoreboard(Player p) {
        ...
        ob.getScore(ChatColor.GREEN.toString() + "§8» §6" + StatsManager.getKills(p.getName())).setScore(10);
        ob.getScore("  ").setScore(9);
        ob.getScore("§c§lTode:").setScore(8);
        ob.getScore(ChatColor.BLACK.toString() + "§8» §6" + StatsManager.getTode(p.getName())).setScore(7);
