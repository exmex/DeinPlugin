...
public class Scoreboard {
	 public static String nextevent = "Laden";
	    ...
	    public static void setScoreboard(Player p) {
	        ...
	        ob.setDisplayName(" §8» §e§lBridgeFighter §8«");
	        ...
	        if(group.equalsIgnoreCase("default")){
		        ...
		        Score s1 = ob.getScore(ChatColor.AQUA.toString() + " §a" + StatsManager.kills.get(p.getName()));
		        Score s2 = ob.getScore(ChatColor.YELLOW.toString());
		        Score s6 = ob.getScore(" §f§lTode:");
		        Score s7 = ob.getScore(ChatColor.BLACK.toString() + " §a" + StatsManager.deaths.get(p.getName()));
		        Score s8 = ob.getScore(" §f§lGegner:");
		        Score s88 = ob.getScore(ChatColor.DARK_PURPLE.toString());
		        if(Data.gegner.get(p.getName()).equals("Unbekannt")){
			        Score s9 = ob.getScore(ChatColor.GRAY.toString() + " §c§l✖");
			        s9.setScore(2);
		        }else{
		        Score s9 = ob.getScore(ChatColor.GRAY.toString() + " §a" + Data.gegner.get(p.getName()));
		        s9.setScore(2);
		        }
